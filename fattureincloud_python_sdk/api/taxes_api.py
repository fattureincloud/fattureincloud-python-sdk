...
class TaxesApi(object):
    ...
    def create_f24(self, company_id, **kwargs):
        ...
        >>> thread = api.create_f24(company_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            create_f24_request (CreateF24Request): The F24 to create. [optional]
    ...
    def get_f24(self, company_id, document_id, **kwargs):
        ...
        >>> thread = api.get_f24(company_id, document_id, async_req=True)
        >>> result = thread.get()
    ...
    def list_f24(self, company_id, **kwargs):
        ...
        >>> thread = api.list_f24(company_id, async_req=True)
        >>> result = thread.get()
    ...
    def modify_f24(self, company_id, document_id, **kwargs):
        ...
        >>> thread = api.modify_f24(company_id, document_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            modify_f24_request (ModifyF24Request): The F24. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def upload_f24_attachment(self, company_id, **kwargs):
        ...
        >>> thread = api.upload_f24_attachment(company_id, async_req=True)
        >>> result = thread.get()
