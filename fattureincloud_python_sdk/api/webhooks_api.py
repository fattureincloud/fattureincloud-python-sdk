...
class WebhooksApi:
    ...
    def verify_webhooks_subscription(
        ...
        :param subscription_id: The ID of the subscription. (required)
        :type subscription_id: str
        :param verify_webhooks_subscription_request:
        :type verify_webhooks_subscription_request: VerifyWebhooksSubscriptionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._verify_webhooks_subscription_serialize(
            company_id=company_id,
            subscription_id=subscription_id,
            verify_webhooks_subscription_request=verify_webhooks_subscription_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    def _verify_webhooks_subscription_serialize(
        ...
        company_id,
        subscription_id,
        verify_webhooks_subscription_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
