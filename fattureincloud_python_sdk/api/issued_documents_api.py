...
class IssuedDocumentsApi(object):
    ...
    def list_issued_documents(
        ...
        **kwargs
        ...
        >>> thread = api.list_issued_documents(company_id, type, fields, fieldset, sort, page, per_page, q, async_req=True)
        >>> result = thread.get()
    ...
    def list_issued_documents_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.list_issued_documents_with_http_info(company_id, type, fields, fieldset, sort, page, per_page, q, async_req=True)
        >>> result = thread.get()
