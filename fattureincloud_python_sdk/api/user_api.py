...
class UserApi:
    ...
    @validate_arguments
    def get_user_info(self, **kwargs) -> GetUserInfoResponse:  # noqa: E501
        """Get User Info  # noqa: E501

        Gets the current user's info.  # noqa: E501
    ...
    @validate_arguments
    def list_user_companies(self, **kwargs) -> ListUserCompaniesResponse:  # noqa: E501
        """List User Companies  # noqa: E501

        Lists the companies controlled by the current user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_user_companies(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListUserCompaniesResponse
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
    ...
    @validate_arguments
    def list_user_companies_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """List User Companies  # noqa: E501
        ...
        >>> thread = api.list_user_companies_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListUserCompaniesResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_user_companies" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
