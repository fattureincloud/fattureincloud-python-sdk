...
class PaymentMethodType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Method type.. if omitted defaults to "standard", must be one of ["standard", "riba", ]  # noqa: E501

        Keyword Args:
            value (str): Method type.. if omitted defaults to "standard", must be one of ["standard", "riba", ]  # noqa: E501
