...
from fattureincloud_python_sdk import rest
from fattureincloud_python_sdk.configuration import Configuration
from fattureincloud_python_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'FattureInCloud/2.0.1/Python-SDK'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ArchiveApi()
        api_instance.create_archive_document  # this is an instance of the class Endpoint
        api_instance.create_archive_document()  # this invokes api_instance.create_archive_document.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_archive_document.callable or self.callable in this class
