...
class CreateSupplierResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSupplierResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSupplierResponse:
        """Create an instance of CreateSupplierResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateSupplierResponse.parse_obj(obj)

        _obj = CreateSupplierResponse.parse_obj(
            {
