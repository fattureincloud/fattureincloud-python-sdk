...
class GetNewIssuedDocumentTotalsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNewIssuedDocumentTotalsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNewIssuedDocumentTotalsResponse:
        """Create an instance of GetNewIssuedDocumentTotalsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetNewIssuedDocumentTotalsResponse.parse_obj(obj)

        _obj = GetNewIssuedDocumentTotalsResponse.parse_obj(
            {
