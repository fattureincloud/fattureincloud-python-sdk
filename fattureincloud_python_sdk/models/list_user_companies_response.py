...
class ListUserCompaniesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUserCompaniesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUserCompaniesResponse:
        """Create an instance of ListUserCompaniesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListUserCompaniesResponse.parse_obj(obj)

        _obj = ListUserCompaniesResponse.parse_obj(
            {
                "data": ListUserCompaniesResponseData.from_dict(obj.get("data"))
