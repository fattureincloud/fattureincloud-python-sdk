...
class GetIssuedDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetIssuedDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetIssuedDocumentResponse:
        """Create an instance of GetIssuedDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetIssuedDocumentResponse.parse_obj(obj)

        _obj = GetIssuedDocumentResponse.parse_obj(
            {
