...
class UploadIssuedDocumentAttachmentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadIssuedDocumentAttachmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadIssuedDocumentAttachmentResponse:
        """Create an instance of UploadIssuedDocumentAttachmentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UploadIssuedDocumentAttachmentResponse.parse_obj(obj)

        _obj = UploadIssuedDocumentAttachmentResponse.parse_obj(
            {
