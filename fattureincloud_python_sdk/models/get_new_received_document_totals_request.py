...
class GetNewReceivedDocumentTotalsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNewReceivedDocumentTotalsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNewReceivedDocumentTotalsRequest:
        """Create an instance of GetNewReceivedDocumentTotalsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetNewReceivedDocumentTotalsRequest.parse_obj(obj)

        _obj = GetNewReceivedDocumentTotalsRequest.parse_obj(
            {
