...
class GetPaymentAccountResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPaymentAccountResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPaymentAccountResponse:
        """Create an instance of GetPaymentAccountResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetPaymentAccountResponse.parse_obj(obj)

        _obj = GetPaymentAccountResponse.parse_obj(
            {
