...
class ListF24ResponseAggregatedData(BaseModel):
    ...
    amount: Optional[StrictFloat] = Field(None, description="Total amount.")
    __properties = ["amount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListF24ResponseAggregatedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListF24ResponseAggregatedData:
        """Create an instance of ListF24ResponseAggregatedData from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListF24ResponseAggregatedData.parse_obj(obj)

        _obj = ListF24ResponseAggregatedData.parse_obj(
            {
