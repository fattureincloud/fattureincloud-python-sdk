...
class ModifySupplierResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifySupplierResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifySupplierResponse:
        """Create an instance of ModifySupplierResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifySupplierResponse.parse_obj(obj)

        _obj = ModifySupplierResponse.parse_obj(
            {
                "data": Supplier.from_dict(obj.get("data"))
