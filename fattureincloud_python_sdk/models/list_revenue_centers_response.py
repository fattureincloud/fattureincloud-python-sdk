...
class ListRevenueCentersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListRevenueCentersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListRevenueCentersResponse:
        """Create an instance of ListRevenueCentersResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListRevenueCentersResponse.parse_obj(obj)

        _obj = ListRevenueCentersResponse.parse_obj({"data": obj.get("data")})
        return _obj
