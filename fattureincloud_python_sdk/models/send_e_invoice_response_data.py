...
class SendEInvoiceResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendEInvoiceResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendEInvoiceResponseData:
        """Create an instance of SendEInvoiceResponseData from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SendEInvoiceResponseData.parse_obj(obj)

        _obj = SendEInvoiceResponseData.parse_obj(
            {
