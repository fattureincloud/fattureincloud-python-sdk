...
class CreateReceiptRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateReceiptRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateReceiptRequest:
        """Create an instance of CreateReceiptRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateReceiptRequest.parse_obj(obj)

        _obj = CreateReceiptRequest.parse_obj(
            {
                "data": Receipt.from_dict(obj.get("data"))
                if obj.get("data") is not None
                else None,
                "autocomplete_number": obj.get("autocomplete_number")
                if obj.get("autocomplete_number") is not None
                else None,
            }
        )
        return _obj
