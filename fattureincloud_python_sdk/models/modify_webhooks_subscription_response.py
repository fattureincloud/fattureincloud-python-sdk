...
class ModifyWebhooksSubscriptionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyWebhooksSubscriptionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyWebhooksSubscriptionResponse:
        """Create an instance of ModifyWebhooksSubscriptionResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyWebhooksSubscriptionResponse.parse_obj(obj)

        _obj = ModifyWebhooksSubscriptionResponse.parse_obj(
            {
                "data": WebhooksSubscription.from_dict(obj.get("data"))
