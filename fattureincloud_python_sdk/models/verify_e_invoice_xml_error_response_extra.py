...
class VerifyEInvoiceXmlErrorResponseExtra(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerifyEInvoiceXmlErrorResponseExtra:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VerifyEInvoiceXmlErrorResponseExtra:
        """Create an instance of VerifyEInvoiceXmlErrorResponseExtra from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VerifyEInvoiceXmlErrorResponseExtra.parse_obj(obj)

        _obj = VerifyEInvoiceXmlErrorResponseExtra.parse_obj(
