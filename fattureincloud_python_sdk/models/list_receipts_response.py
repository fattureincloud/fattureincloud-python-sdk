...
class ListReceiptsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListReceiptsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListReceiptsResponse:
        """Create an instance of ListReceiptsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListReceiptsResponse.parse_obj(obj)

        _obj = ListReceiptsResponse.parse_obj(
            {
