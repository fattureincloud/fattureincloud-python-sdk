...
class GetEmailDataResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetEmailDataResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetEmailDataResponse:
        """Create an instance of GetEmailDataResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetEmailDataResponse.parse_obj(obj)

        _obj = GetEmailDataResponse.parse_obj(
            {
                "data": EmailData.from_dict(obj.get("data"))
