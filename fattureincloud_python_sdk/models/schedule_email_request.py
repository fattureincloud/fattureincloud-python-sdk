...
class ScheduleEmailRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScheduleEmailRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScheduleEmailRequest:
        """Create an instance of ScheduleEmailRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ScheduleEmailRequest.parse_obj(obj)

        _obj = ScheduleEmailRequest.parse_obj(
            {
                "data": EmailSchedule.from_dict(obj.get("data"))
