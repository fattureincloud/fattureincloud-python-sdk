...
class ListDetailedCountriesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDetailedCountriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDetailedCountriesResponse:
        """Create an instance of ListDetailedCountriesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListDetailedCountriesResponse.parse_obj(obj)

        _obj = ListDetailedCountriesResponse.parse_obj(
            {
                "data": [DetailedCountry.from_dict(_item) for _item in obj.get("data")]
