...
class ListCurrenciesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCurrenciesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCurrenciesResponse:
        """Create an instance of ListCurrenciesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListCurrenciesResponse.parse_obj(obj)

        _obj = ListCurrenciesResponse.parse_obj(
            {
                "data": [Currency.from_dict(_item) for _item in obj.get("data")]
