...
class CreateClientResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateClientResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateClientResponse:
        """Create an instance of CreateClientResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateClientResponse.parse_obj(obj)

        _obj = CreateClientResponse.parse_obj(
            {
