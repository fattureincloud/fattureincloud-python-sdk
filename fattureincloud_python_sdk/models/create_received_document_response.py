...
class CreateReceivedDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateReceivedDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateReceivedDocumentResponse:
        """Create an instance of CreateReceivedDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateReceivedDocumentResponse.parse_obj(obj)

        _obj = CreateReceivedDocumentResponse.parse_obj(
            {
