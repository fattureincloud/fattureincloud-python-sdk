...
class CreateArchiveDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateArchiveDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateArchiveDocumentResponse:
        """Create an instance of CreateArchiveDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateArchiveDocumentResponse.parse_obj(obj)

        _obj = CreateArchiveDocumentResponse.parse_obj(
            {
