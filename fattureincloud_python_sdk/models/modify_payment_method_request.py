...
class ModifyPaymentMethodRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyPaymentMethodRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyPaymentMethodRequest:
        """Create an instance of ModifyPaymentMethodRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyPaymentMethodRequest.parse_obj(obj)

        _obj = ModifyPaymentMethodRequest.parse_obj(
            {
