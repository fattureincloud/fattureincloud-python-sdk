...
class ReceivedDocumentInfoDefaultValues(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReceivedDocumentInfoDefaultValues:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReceivedDocumentInfoDefaultValues:
        """Create an instance of ReceivedDocumentInfoDefaultValues from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ReceivedDocumentInfoDefaultValues.parse_obj(obj)

        _obj = ReceivedDocumentInfoDefaultValues.parse_obj(
            {
                "detailed": obj.get("detailed")
                if obj.get("detailed") is not None
                else None
            }
        )
        return _obj
