...
class CreateWebhooksSubscriptionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateWebhooksSubscriptionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateWebhooksSubscriptionResponse:
        """Create an instance of CreateWebhooksSubscriptionResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateWebhooksSubscriptionResponse.parse_obj(obj)

        _obj = CreateWebhooksSubscriptionResponse.parse_obj(
            {
