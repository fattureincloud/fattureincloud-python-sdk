...
class CashbookEntryDocument(BaseModel):
    ...
    id: Optional[StrictInt] = Field(None, description="Document unique identifier.")
    type: Optional[StrictStr] = Field(None, description="Document type.")
    path: Optional[StrictStr] = Field(None, description="Document path.")
