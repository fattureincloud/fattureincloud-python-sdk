...
class ModifyIssuedDocumentRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyIssuedDocumentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyIssuedDocumentRequest:
        """Create an instance of ModifyIssuedDocumentRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyIssuedDocumentRequest.parse_obj(obj)

        _obj = ModifyIssuedDocumentRequest.parse_obj(
            {
