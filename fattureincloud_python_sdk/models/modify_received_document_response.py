...
class ModifyReceivedDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyReceivedDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyReceivedDocumentResponse:
        """Create an instance of ModifyReceivedDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyReceivedDocumentResponse.parse_obj(obj)

        _obj = ModifyReceivedDocumentResponse.parse_obj(
            {
