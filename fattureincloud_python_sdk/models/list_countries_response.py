...
class ListCountriesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCountriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCountriesResponse:
        """Create an instance of ListCountriesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListCountriesResponse.parse_obj(obj)

        _obj = ListCountriesResponse.parse_obj({"data": obj.get("data")})
        return _obj
