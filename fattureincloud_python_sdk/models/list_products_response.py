...
class ListProductsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListProductsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListProductsResponse:
        """Create an instance of ListProductsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListProductsResponse.parse_obj(obj)

        _obj = ListProductsResponse.parse_obj(
            {
