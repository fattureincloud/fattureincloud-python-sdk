...
class CreateProductResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProductResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProductResponse:
        """Create an instance of CreateProductResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateProductResponse.parse_obj(obj)

        _obj = CreateProductResponse.parse_obj(
            {
