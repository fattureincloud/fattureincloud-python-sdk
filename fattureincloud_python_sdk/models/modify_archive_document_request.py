...
class ModifyArchiveDocumentRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyArchiveDocumentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyArchiveDocumentRequest:
        """Create an instance of ModifyArchiveDocumentRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyArchiveDocumentRequest.parse_obj(obj)

        _obj = ModifyArchiveDocumentRequest.parse_obj(
            {
