...
class GetNewIssuedDocumentTotalsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNewIssuedDocumentTotalsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNewIssuedDocumentTotalsRequest:
        """Create an instance of GetNewIssuedDocumentTotalsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetNewIssuedDocumentTotalsRequest.parse_obj(obj)

        _obj = GetNewIssuedDocumentTotalsRequest.parse_obj(
            {
