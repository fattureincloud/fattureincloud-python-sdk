...
class CompanyInfoPlanInfoLimits(BaseModel):
    ...
    suppliers: Optional[StrictInt] = None
    products: Optional[StrictInt] = None
    documents: Optional[StrictInt] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompanyInfoPlanInfoLimits:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompanyInfoPlanInfoLimits:
        """Create an instance of CompanyInfoPlanInfoLimits from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CompanyInfoPlanInfoLimits.parse_obj(obj)

        _obj = CompanyInfoPlanInfoLimits.parse_obj(
            {
                "clients": obj.get("clients")
                if obj.get("clients") is not None
                else None,
                "suppliers": obj.get("suppliers")
                if obj.get("suppliers") is not None
                else None,
