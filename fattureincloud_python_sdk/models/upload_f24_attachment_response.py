...
class UploadF24AttachmentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadF24AttachmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadF24AttachmentResponse:
        """Create an instance of UploadF24AttachmentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UploadF24AttachmentResponse.parse_obj(obj)

        _obj = UploadF24AttachmentResponse.parse_obj(
            {
