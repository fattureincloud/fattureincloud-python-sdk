...
class GetCompanyInfoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCompanyInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCompanyInfoResponse:
        """Create an instance of GetCompanyInfoResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetCompanyInfoResponse.parse_obj(obj)

        _obj = GetCompanyInfoResponse.parse_obj(
            {
                "data": CompanyInfo.from_dict(obj.get("data"))
