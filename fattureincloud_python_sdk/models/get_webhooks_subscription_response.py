...
class GetWebhooksSubscriptionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWebhooksSubscriptionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWebhooksSubscriptionResponse:
        """Create an instance of GetWebhooksSubscriptionResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetWebhooksSubscriptionResponse.parse_obj(obj)

        _obj = GetWebhooksSubscriptionResponse.parse_obj(
            {
