...
class UploadReceivedDocumentAttachmentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadReceivedDocumentAttachmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadReceivedDocumentAttachmentResponse:
        """Create an instance of UploadReceivedDocumentAttachmentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UploadReceivedDocumentAttachmentResponse.parse_obj(obj)

        _obj = UploadReceivedDocumentAttachmentResponse.parse_obj(
            {
                "data": AttachmentData.from_dict(obj.get("data"))
