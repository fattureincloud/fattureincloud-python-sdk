...
class GetExistingIssuedDocumentTotalsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExistingIssuedDocumentTotalsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExistingIssuedDocumentTotalsRequest:
        """Create an instance of GetExistingIssuedDocumentTotalsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetExistingIssuedDocumentTotalsRequest.parse_obj(obj)

        _obj = GetExistingIssuedDocumentTotalsRequest.parse_obj(
            {
