...
class SendEInvoiceRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendEInvoiceRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendEInvoiceRequest:
        """Create an instance of SendEInvoiceRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SendEInvoiceRequest.parse_obj(obj)

        _obj = SendEInvoiceRequest.parse_obj(
            {
                "data": SendEInvoiceRequestData.from_dict(obj.get("data"))
                if obj.get("data") is not None
                else None,
                "options": SendEInvoiceRequestOptions.from_dict(obj.get("options"))
