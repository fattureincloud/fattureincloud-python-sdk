...
class ListF24Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListF24Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListF24Response:
        """Create an instance of ListF24Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListF24Response.parse_obj(obj)

        _obj = ListF24Response.parse_obj(
            {
