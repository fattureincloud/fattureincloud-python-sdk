...
class GetClientResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetClientResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetClientResponse:
        """Create an instance of GetClientResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetClientResponse.parse_obj(obj)

        _obj = GetClientResponse.parse_obj(
            {
