...
class ListSuppliersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSuppliersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSuppliersResponse:
        """Create an instance of ListSuppliersResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListSuppliersResponse.parse_obj(obj)

        _obj = ListSuppliersResponse.parse_obj(
            {
