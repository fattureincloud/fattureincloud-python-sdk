...
class ModifyClientResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyClientResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyClientResponse:
        """Create an instance of ModifyClientResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyClientResponse.parse_obj(obj)

        _obj = ModifyClientResponse.parse_obj(
            {
                "data": Client.from_dict(obj.get("data"))
