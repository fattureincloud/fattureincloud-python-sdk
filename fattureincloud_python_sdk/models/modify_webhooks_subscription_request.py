...
class ModifyWebhooksSubscriptionRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyWebhooksSubscriptionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyWebhooksSubscriptionRequest:
        """Create an instance of ModifyWebhooksSubscriptionRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyWebhooksSubscriptionRequest.parse_obj(obj)

        _obj = ModifyWebhooksSubscriptionRequest.parse_obj(
            {
