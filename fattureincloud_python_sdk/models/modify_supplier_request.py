...
class ModifySupplierRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifySupplierRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifySupplierRequest:
        """Create an instance of ModifySupplierRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifySupplierRequest.parse_obj(obj)

        _obj = ModifySupplierRequest.parse_obj(
            {
