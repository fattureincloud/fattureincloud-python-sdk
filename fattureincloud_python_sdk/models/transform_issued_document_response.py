...
class TransformIssuedDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransformIssuedDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransformIssuedDocumentResponse:
        """Create an instance of TransformIssuedDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TransformIssuedDocumentResponse.parse_obj(obj)

        _obj = TransformIssuedDocumentResponse.parse_obj(
            {
