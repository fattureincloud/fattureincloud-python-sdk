...
class GetVatTypeResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetVatTypeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetVatTypeResponse:
        """Create an instance of GetVatTypeResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetVatTypeResponse.parse_obj(obj)

        _obj = GetVatTypeResponse.parse_obj(
            {
