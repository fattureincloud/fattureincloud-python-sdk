...
class ListCashbookEntriesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCashbookEntriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCashbookEntriesResponse:
        """Create an instance of ListCashbookEntriesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListCashbookEntriesResponse.parse_obj(obj)

        _obj = ListCashbookEntriesResponse.parse_obj(
            {
                "data": [CashbookEntry.from_dict(_item) for _item in obj.get("data")]
