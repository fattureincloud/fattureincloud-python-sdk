...
class UploadArchiveAttachmentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadArchiveAttachmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadArchiveAttachmentResponse:
        """Create an instance of UploadArchiveAttachmentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UploadArchiveAttachmentResponse.parse_obj(obj)

        _obj = UploadArchiveAttachmentResponse.parse_obj(
            {
