...
class ListIssuedDocumentsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListIssuedDocumentsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListIssuedDocumentsResponse:
        """Create an instance of ListIssuedDocumentsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListIssuedDocumentsResponse.parse_obj(obj)

        _obj = ListIssuedDocumentsResponse.parse_obj(
            {
