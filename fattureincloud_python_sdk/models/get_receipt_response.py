...
class GetReceiptResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReceiptResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReceiptResponse:
        """Create an instance of GetReceiptResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetReceiptResponse.parse_obj(obj)

        _obj = GetReceiptResponse.parse_obj(
            {
