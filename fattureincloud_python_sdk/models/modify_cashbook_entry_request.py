...
class ModifyCashbookEntryRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyCashbookEntryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyCashbookEntryRequest:
        """Create an instance of ModifyCashbookEntryRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyCashbookEntryRequest.parse_obj(obj)

        _obj = ModifyCashbookEntryRequest.parse_obj(
            {
