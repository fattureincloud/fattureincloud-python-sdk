...
class ModifyProductResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyProductResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyProductResponse:
        """Create an instance of ModifyProductResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyProductResponse.parse_obj(obj)

        _obj = ModifyProductResponse.parse_obj(
            {
                "data": Product.from_dict(obj.get("data"))
