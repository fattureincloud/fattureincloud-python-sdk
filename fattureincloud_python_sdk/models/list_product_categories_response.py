...
class ListProductCategoriesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListProductCategoriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListProductCategoriesResponse:
        """Create an instance of ListProductCategoriesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListProductCategoriesResponse.parse_obj(obj)

        _obj = ListProductCategoriesResponse.parse_obj({"data": obj.get("data")})
        return _obj
