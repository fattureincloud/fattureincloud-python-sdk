...
class ListArchiveCategoriesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListArchiveCategoriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListArchiveCategoriesResponse:
        """Create an instance of ListArchiveCategoriesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListArchiveCategoriesResponse.parse_obj(obj)

        _obj = ListArchiveCategoriesResponse.parse_obj({"data": obj.get("data")})
        return _obj
