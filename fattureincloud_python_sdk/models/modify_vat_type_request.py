...
class ModifyVatTypeRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyVatTypeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyVatTypeRequest:
        """Create an instance of ModifyVatTypeRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyVatTypeRequest.parse_obj(obj)

        _obj = ModifyVatTypeRequest.parse_obj(
            {
