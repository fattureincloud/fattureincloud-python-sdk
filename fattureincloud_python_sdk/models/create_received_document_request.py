...
class CreateReceivedDocumentRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateReceivedDocumentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateReceivedDocumentRequest:
        """Create an instance of CreateReceivedDocumentRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateReceivedDocumentRequest.parse_obj(obj)

        _obj = CreateReceivedDocumentRequest.parse_obj(
            {
                "pending_id": obj.get("pending_id")
                if obj.get("pending_id") is not None
                else None,
