...
class AttachmentData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttachmentData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttachmentData:
        """Create an instance of AttachmentData from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttachmentData.parse_obj(obj)

        _obj = AttachmentData.parse_obj(
            {
