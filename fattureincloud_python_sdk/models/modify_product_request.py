...
class ModifyProductRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyProductRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyProductRequest:
        """Create an instance of ModifyProductRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyProductRequest.parse_obj(obj)

        _obj = ModifyProductRequest.parse_obj(
            {
