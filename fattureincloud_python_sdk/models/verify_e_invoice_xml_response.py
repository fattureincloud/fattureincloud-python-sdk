...
class VerifyEInvoiceXmlResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerifyEInvoiceXmlResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VerifyEInvoiceXmlResponse:
        """Create an instance of VerifyEInvoiceXmlResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VerifyEInvoiceXmlResponse.parse_obj(obj)

        _obj = VerifyEInvoiceXmlResponse.parse_obj(
            {
                "data": VerifyEInvoiceXmlResponseData.from_dict(obj.get("data"))
