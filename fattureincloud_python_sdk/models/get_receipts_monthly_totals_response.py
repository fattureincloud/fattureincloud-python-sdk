...
class GetReceiptsMonthlyTotalsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReceiptsMonthlyTotalsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReceiptsMonthlyTotalsResponse:
        """Create an instance of GetReceiptsMonthlyTotalsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetReceiptsMonthlyTotalsResponse.parse_obj(obj)

        _obj = GetReceiptsMonthlyTotalsResponse.parse_obj(
            {
                "data": [MonthlyTotal.from_dict(_item) for _item in obj.get("data")]
