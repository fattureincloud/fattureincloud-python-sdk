...
class ListCostCentersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCostCentersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCostCentersResponse:
        """Create an instance of ListCostCentersResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListCostCentersResponse.parse_obj(obj)

        _obj = ListCostCentersResponse.parse_obj({"data": obj.get("data")})
        return _obj
