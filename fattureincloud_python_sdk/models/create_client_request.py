...
class CreateClientRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateClientRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateClientRequest:
        """Create an instance of CreateClientRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateClientRequest.parse_obj(obj)

        _obj = CreateClientRequest.parse_obj(
            {
