...
class ModifyArchiveDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyArchiveDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyArchiveDocumentResponse:
        """Create an instance of ModifyArchiveDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyArchiveDocumentResponse.parse_obj(obj)

        _obj = ModifyArchiveDocumentResponse.parse_obj(
            {
                "data": ArchiveDocument.from_dict(obj.get("data"))
