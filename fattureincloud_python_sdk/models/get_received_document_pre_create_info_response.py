...
class GetReceivedDocumentPreCreateInfoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReceivedDocumentPreCreateInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReceivedDocumentPreCreateInfoResponse:
        """Create an instance of GetReceivedDocumentPreCreateInfoResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetReceivedDocumentPreCreateInfoResponse.parse_obj(obj)

        _obj = GetReceivedDocumentPreCreateInfoResponse.parse_obj(
            {
                "data": ReceivedDocumentInfo.from_dict(obj.get("data"))
