...
class ModifyReceiptResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyReceiptResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyReceiptResponse:
        """Create an instance of ModifyReceiptResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyReceiptResponse.parse_obj(obj)

        _obj = ModifyReceiptResponse.parse_obj(
            {
