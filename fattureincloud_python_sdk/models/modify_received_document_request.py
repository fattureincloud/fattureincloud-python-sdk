...
class ModifyReceivedDocumentRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyReceivedDocumentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyReceivedDocumentRequest:
        """Create an instance of ModifyReceivedDocumentRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyReceivedDocumentRequest.parse_obj(obj)

        _obj = ModifyReceivedDocumentRequest.parse_obj(
            {
