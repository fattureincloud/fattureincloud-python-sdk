...
class GetArchiveDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetArchiveDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetArchiveDocumentResponse:
        """Create an instance of GetArchiveDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetArchiveDocumentResponse.parse_obj(obj)

        _obj = GetArchiveDocumentResponse.parse_obj(
            {
