...
class ModifyPaymentAccountResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyPaymentAccountResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyPaymentAccountResponse:
        """Create an instance of ModifyPaymentAccountResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyPaymentAccountResponse.parse_obj(obj)

        _obj = ModifyPaymentAccountResponse.parse_obj(
            {
