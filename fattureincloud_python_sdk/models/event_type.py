...
class EventType(str, Enum):
    ...
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ARCHIVE_DOCUMENTS_DOT_DELETE = (
    ...
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_RECEIVED_DOCUMENTS_DOT_E_INVOICES_DOT_RECEIVE = (
        "it.fattureincloud.webhooks.received_documents.e_invoices.receive"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_INVOICES_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.invoices.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_QUOTES_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.quotes.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_PROFORMAS_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.proformas.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_RECEIPTS_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.receipts.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_DELIVERY_NOTES_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.delivery_notes.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_CREDIT_NOTES_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.credit_notes.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_ORDERS_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.orders.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_WORK_REPORTS_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.work_reports.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_SUPPLIER_ORDERS_DOT_EMAIL_SENT = (
        "it.fattureincloud.webhooks.issued_documents.supplier_orders.email_sent"
    )
    IT_DOT_FATTUREINCLOUD_DOT_WEBHOOKS_DOT_ISSUED_DOCUMENTS_DOT_SELF_INVOICES_DOT_EMAIL_SENT = (
