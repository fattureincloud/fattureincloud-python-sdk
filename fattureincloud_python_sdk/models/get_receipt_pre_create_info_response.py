...
class GetReceiptPreCreateInfoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReceiptPreCreateInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReceiptPreCreateInfoResponse:
        """Create an instance of GetReceiptPreCreateInfoResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetReceiptPreCreateInfoResponse.parse_obj(obj)

        _obj = GetReceiptPreCreateInfoResponse.parse_obj(
            {
                "data": ReceiptPreCreateInfo.from_dict(obj.get("data"))
