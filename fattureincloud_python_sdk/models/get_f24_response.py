...
class GetF24Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetF24Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetF24Response:
        """Create an instance of GetF24Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetF24Response.parse_obj(obj)

        _obj = GetF24Response.parse_obj(
            {
