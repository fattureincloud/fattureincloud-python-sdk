...
class CreateWebhooksSubscriptionRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateWebhooksSubscriptionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateWebhooksSubscriptionRequest:
        """Create an instance of CreateWebhooksSubscriptionRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateWebhooksSubscriptionRequest.parse_obj(obj)

        _obj = CreateWebhooksSubscriptionRequest.parse_obj(
            {
