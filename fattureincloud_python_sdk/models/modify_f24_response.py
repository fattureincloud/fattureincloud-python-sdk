...
class ModifyF24Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyF24Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyF24Response:
        """Create an instance of ModifyF24Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyF24Response.parse_obj(obj)

        _obj = ModifyF24Response.parse_obj(
            {
                "data": F24.from_dict(obj.get("data"))
