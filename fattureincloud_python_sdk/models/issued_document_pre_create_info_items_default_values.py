...
class IssuedDocumentPreCreateInfoItemsDefaultValues(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssuedDocumentPreCreateInfoItemsDefaultValues:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssuedDocumentPreCreateInfoItemsDefaultValues:
        """Create an instance of IssuedDocumentPreCreateInfoItemsDefaultValues from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return IssuedDocumentPreCreateInfoItemsDefaultValues.parse_obj(obj)

        _obj = IssuedDocumentPreCreateInfoItemsDefaultValues.parse_obj(
            {
