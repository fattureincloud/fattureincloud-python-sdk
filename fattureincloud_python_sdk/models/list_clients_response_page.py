...
class ListClientsResponsePage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListClientsResponsePage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListClientsResponsePage:
        """Create an instance of ListClientsResponsePage from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListClientsResponsePage.parse_obj(obj)

        _obj = ListClientsResponsePage.parse_obj(
            {
