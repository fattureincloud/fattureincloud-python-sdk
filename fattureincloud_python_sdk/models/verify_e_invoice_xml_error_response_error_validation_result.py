...
class VerifyEInvoiceXmlErrorResponseErrorValidationResult(BaseModel):
    ...
    xml_errors: Optional[conlist(StrictStr)] = None
    __properties = ["xml_errors"]
    ...
    def from_dict(
        ...
        if type(obj) is not dict:
            return VerifyEInvoiceXmlErrorResponseErrorValidationResult.parse_obj(obj)

        _obj = VerifyEInvoiceXmlErrorResponseErrorValidationResult.parse_obj(
