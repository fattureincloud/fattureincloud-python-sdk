...
class ListCitiesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCitiesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCitiesResponse:
        """Create an instance of ListCitiesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListCitiesResponse.parse_obj(obj)

        _obj = ListCitiesResponse.parse_obj(
            {
                "data": [City.from_dict(_item) for _item in obj.get("data")]
