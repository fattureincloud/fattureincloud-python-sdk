...
class ModifyF24Request(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyF24Request:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyF24Request:
        """Create an instance of ModifyF24Request from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyF24Request.parse_obj(obj)

        _obj = ModifyF24Request.parse_obj(
            {
