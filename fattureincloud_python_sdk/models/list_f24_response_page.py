...
class ListF24ResponsePage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListF24ResponsePage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListF24ResponsePage:
        """Create an instance of ListF24ResponsePage from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListF24ResponsePage.parse_obj(obj)

        _obj = ListF24ResponsePage.parse_obj(
            {
                "data": [F24.from_dict(_item) for _item in obj.get("data")]
