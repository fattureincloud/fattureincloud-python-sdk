...
class ModifyReceiptRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyReceiptRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyReceiptRequest:
        """Create an instance of ModifyReceiptRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyReceiptRequest.parse_obj(obj)

        _obj = ModifyReceiptRequest.parse_obj(
            {
