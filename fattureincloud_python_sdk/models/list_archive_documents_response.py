...
class ListArchiveDocumentsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListArchiveDocumentsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListArchiveDocumentsResponse:
        """Create an instance of ListArchiveDocumentsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListArchiveDocumentsResponse.parse_obj(obj)

        _obj = ListArchiveDocumentsResponse.parse_obj(
            {
