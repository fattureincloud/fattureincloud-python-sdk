...
class ListSuppliersResponsePage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSuppliersResponsePage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSuppliersResponsePage:
        """Create an instance of ListSuppliersResponsePage from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListSuppliersResponsePage.parse_obj(obj)

        _obj = ListSuppliersResponsePage.parse_obj(
            {
