...
class ListUserCompaniesResponseData(BaseModel):
    ...
    companies: Optional[conlist(Company)] = None
    __properties = ["companies"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUserCompaniesResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUserCompaniesResponseData:
        """Create an instance of ListUserCompaniesResponseData from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListUserCompaniesResponseData.parse_obj(obj)

        _obj = ListUserCompaniesResponseData.parse_obj(
            {
                "companies": [
                    Company.from_dict(_item) for _item in obj.get("companies")
                ]
