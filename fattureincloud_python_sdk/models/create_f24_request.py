...
class CreateF24Request(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateF24Request:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateF24Request:
        """Create an instance of CreateF24Request from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateF24Request.parse_obj(obj)

        _obj = CreateF24Request.parse_obj(
            {
