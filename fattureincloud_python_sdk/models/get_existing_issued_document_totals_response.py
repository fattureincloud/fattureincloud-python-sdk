...
class GetExistingIssuedDocumentTotalsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExistingIssuedDocumentTotalsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExistingIssuedDocumentTotalsResponse:
        """Create an instance of GetExistingIssuedDocumentTotalsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetExistingIssuedDocumentTotalsResponse.parse_obj(obj)

        _obj = GetExistingIssuedDocumentTotalsResponse.parse_obj(
            {
                "data": IssuedDocumentTotals.from_dict(obj.get("data"))
