...
class ModifyClientRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyClientRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyClientRequest:
        """Create an instance of ModifyClientRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyClientRequest.parse_obj(obj)

        _obj = ModifyClientRequest.parse_obj(
            {
