...
class ListDeliveryNotesDefaultCausalsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDeliveryNotesDefaultCausalsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDeliveryNotesDefaultCausalsResponse:
        """Create an instance of ListDeliveryNotesDefaultCausalsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListDeliveryNotesDefaultCausalsResponse.parse_obj(obj)

        _obj = ListDeliveryNotesDefaultCausalsResponse.parse_obj(
            {"data": obj.get("data")}
        )
        return _obj
