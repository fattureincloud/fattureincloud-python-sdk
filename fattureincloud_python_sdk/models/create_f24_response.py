...
class CreateF24Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateF24Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateF24Response:
        """Create an instance of CreateF24Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateF24Response.parse_obj(obj)

        _obj = CreateF24Response.parse_obj(
            {
