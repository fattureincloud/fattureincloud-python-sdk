...
class ListReceivedDocumentCategoriesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListReceivedDocumentCategoriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListReceivedDocumentCategoriesResponse:
        """Create an instance of ListReceivedDocumentCategoriesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListReceivedDocumentCategoriesResponse.parse_obj(obj)

        _obj = ListReceivedDocumentCategoriesResponse.parse_obj(
            {"data": obj.get("data")}
        )
        return _obj
