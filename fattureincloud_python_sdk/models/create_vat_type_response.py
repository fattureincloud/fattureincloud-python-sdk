...
class CreateVatTypeResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateVatTypeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateVatTypeResponse:
        """Create an instance of CreateVatTypeResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateVatTypeResponse.parse_obj(obj)

        _obj = CreateVatTypeResponse.parse_obj(
            {
                "data": VatType.from_dict(obj.get("data"))
