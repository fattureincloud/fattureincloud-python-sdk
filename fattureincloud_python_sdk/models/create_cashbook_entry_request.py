...
class CreateCashbookEntryRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCashbookEntryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCashbookEntryRequest:
        """Create an instance of CreateCashbookEntryRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateCashbookEntryRequest.parse_obj(obj)

        _obj = CreateCashbookEntryRequest.parse_obj(
            {
