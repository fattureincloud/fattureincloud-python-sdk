...
class CreateCashbookEntryResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCashbookEntryResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCashbookEntryResponse:
        """Create an instance of CreateCashbookEntryResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateCashbookEntryResponse.parse_obj(obj)

        _obj = CreateCashbookEntryResponse.parse_obj(
            {
