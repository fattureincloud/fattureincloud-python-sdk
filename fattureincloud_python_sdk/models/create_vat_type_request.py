...
class CreateVatTypeRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateVatTypeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateVatTypeRequest:
        """Create an instance of CreateVatTypeRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateVatTypeRequest.parse_obj(obj)

        _obj = CreateVatTypeRequest.parse_obj(
            {
