...
class GetExistingReceivedDocumentTotalsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExistingReceivedDocumentTotalsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExistingReceivedDocumentTotalsRequest:
        """Create an instance of GetExistingReceivedDocumentTotalsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetExistingReceivedDocumentTotalsRequest.parse_obj(obj)

        _obj = GetExistingReceivedDocumentTotalsRequest.parse_obj(
            {
