...
class GetNewReceivedDocumentTotalsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNewReceivedDocumentTotalsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNewReceivedDocumentTotalsResponse:
        """Create an instance of GetNewReceivedDocumentTotalsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetNewReceivedDocumentTotalsResponse.parse_obj(obj)

        _obj = GetNewReceivedDocumentTotalsResponse.parse_obj(
            {
