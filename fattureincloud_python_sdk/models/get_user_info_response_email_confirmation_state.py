...
class GetUserInfoResponseEmailConfirmationState(BaseModel):
    ...
    __properties = ["need_confirmation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetUserInfoResponseEmailConfirmationState:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetUserInfoResponseEmailConfirmationState:
        """Create an instance of GetUserInfoResponseEmailConfirmationState from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetUserInfoResponseEmailConfirmationState.parse_obj(obj)

        _obj = GetUserInfoResponseEmailConfirmationState.parse_obj(
            {
                "need_confirmation": obj.get("need_confirmation")
                if obj.get("need_confirmation") is not None
                else None
            }
        )
        return _obj
