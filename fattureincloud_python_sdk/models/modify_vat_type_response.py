...
class ModifyVatTypeResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyVatTypeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyVatTypeResponse:
        """Create an instance of ModifyVatTypeResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyVatTypeResponse.parse_obj(obj)

        _obj = ModifyVatTypeResponse.parse_obj(
            {
