...
class ListUnitsOfMeasureResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnitsOfMeasureResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnitsOfMeasureResponse:
        """Create an instance of ListUnitsOfMeasureResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListUnitsOfMeasureResponse.parse_obj(obj)

        _obj = ListUnitsOfMeasureResponse.parse_obj({"data": obj.get("data")})
        return _obj
