...
class GetExistingReceivedDocumentTotalsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExistingReceivedDocumentTotalsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExistingReceivedDocumentTotalsResponse:
        """Create an instance of GetExistingReceivedDocumentTotalsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetExistingReceivedDocumentTotalsResponse.parse_obj(obj)

        _obj = GetExistingReceivedDocumentTotalsResponse.parse_obj(
            {
                "data": ReceivedDocumentTotals.from_dict(obj.get("data"))
