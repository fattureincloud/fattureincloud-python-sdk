...
class SendEInvoiceResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendEInvoiceResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendEInvoiceResponse:
        """Create an instance of SendEInvoiceResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SendEInvoiceResponse.parse_obj(obj)

        _obj = SendEInvoiceResponse.parse_obj(
            {
                "data": SendEInvoiceResponseData.from_dict(obj.get("data"))
