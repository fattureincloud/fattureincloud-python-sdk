...
class GetEInvoiceRejectionReasonResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetEInvoiceRejectionReasonResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetEInvoiceRejectionReasonResponse:
        """Create an instance of GetEInvoiceRejectionReasonResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetEInvoiceRejectionReasonResponse.parse_obj(obj)

        _obj = GetEInvoiceRejectionReasonResponse.parse_obj(
            {
                "data": EInvoiceRejectionReason.from_dict(obj.get("data"))
