...
class CreateReceiptResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateReceiptResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateReceiptResponse:
        """Create an instance of CreateReceiptResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateReceiptResponse.parse_obj(obj)

        _obj = CreateReceiptResponse.parse_obj(
            {
