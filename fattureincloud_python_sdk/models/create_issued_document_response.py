...
class CreateIssuedDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateIssuedDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateIssuedDocumentResponse:
        """Create an instance of CreateIssuedDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateIssuedDocumentResponse.parse_obj(obj)

        _obj = CreateIssuedDocumentResponse.parse_obj(
            {
