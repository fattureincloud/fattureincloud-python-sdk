...
class ModifyIssuedDocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyIssuedDocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyIssuedDocumentResponse:
        """Create an instance of ModifyIssuedDocumentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyIssuedDocumentResponse.parse_obj(obj)

        _obj = ModifyIssuedDocumentResponse.parse_obj(
            {
