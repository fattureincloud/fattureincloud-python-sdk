...
class GetCashbookEntryResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCashbookEntryResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCashbookEntryResponse:
        """Create an instance of GetCashbookEntryResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetCashbookEntryResponse.parse_obj(obj)

        _obj = GetCashbookEntryResponse.parse_obj(
            {
