...
class VerifyEInvoiceXmlResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerifyEInvoiceXmlResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VerifyEInvoiceXmlResponseData:
        """Create an instance of VerifyEInvoiceXmlResponseData from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VerifyEInvoiceXmlResponseData.parse_obj(obj)

        _obj = VerifyEInvoiceXmlResponseData.parse_obj(
            {"success": obj.get("success") if obj.get("success") is not None else None}
        )
        return _obj
