...
class CreatePaymentAccountResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePaymentAccountResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePaymentAccountResponse:
        """Create an instance of CreatePaymentAccountResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreatePaymentAccountResponse.parse_obj(obj)

        _obj = CreatePaymentAccountResponse.parse_obj(
            {
