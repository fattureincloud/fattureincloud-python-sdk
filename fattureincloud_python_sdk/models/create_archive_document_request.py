...
class CreateArchiveDocumentRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateArchiveDocumentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateArchiveDocumentRequest:
        """Create an instance of CreateArchiveDocumentRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateArchiveDocumentRequest.parse_obj(obj)

        _obj = CreateArchiveDocumentRequest.parse_obj(
            {
