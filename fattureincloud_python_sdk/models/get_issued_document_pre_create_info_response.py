...
class GetIssuedDocumentPreCreateInfoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetIssuedDocumentPreCreateInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetIssuedDocumentPreCreateInfoResponse:
        """Create an instance of GetIssuedDocumentPreCreateInfoResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetIssuedDocumentPreCreateInfoResponse.parse_obj(obj)

        _obj = GetIssuedDocumentPreCreateInfoResponse.parse_obj(
            {
                "data": IssuedDocumentPreCreateInfo.from_dict(obj.get("data"))
