...
class ListTemplatesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTemplatesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTemplatesResponse:
        """Create an instance of ListTemplatesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListTemplatesResponse.parse_obj(obj)

        _obj = ListTemplatesResponse.parse_obj(
            {
                "data": [DocumentTemplate.from_dict(_item) for _item in obj.get("data")]
