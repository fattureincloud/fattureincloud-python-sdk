...
class ModifyPaymentAccountRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyPaymentAccountRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyPaymentAccountRequest:
        """Create an instance of ModifyPaymentAccountRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ModifyPaymentAccountRequest.parse_obj(obj)

        _obj = ModifyPaymentAccountRequest.parse_obj(
            {
