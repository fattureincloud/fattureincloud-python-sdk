...
class GetSupplierResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSupplierResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSupplierResponse:
        """Create an instance of GetSupplierResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetSupplierResponse.parse_obj(obj)

        _obj = GetSupplierResponse.parse_obj(
            {
