...
with fattureincloud_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tax Profile
        api_response = api_instance.get_tax_profile(company_id)
        print("The response of SettingsApi->get_tax_profile:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SettingsApi->get_tax_profile: %s\n" % e)
```
