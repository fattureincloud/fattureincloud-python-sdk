...
- `ISSUED_DOCUMENTS_SELF_SUPPLIER_INVOICES_UPDATE` (value: `'it.fattureincloud.webhooks.issued_documents.self_supplier_iinvoices.update'`)

- `ISSUED_DOCUMENTS_SELF_SUPPLIER_INVOICES_DELETE` (value: `'it.fattureincloud.webhooks.issued_documents.self_supplier_iinvoices.delete'`)
