...
class TestGetCashbookEntryResponse(unittest.TestCase):
    """GetCashbookEntryResponse unit test stubs"""
    ...
    def testGetCashbookEntryResponse(self):
        """Test GetCashbookEntryResponse"""
        model = GetCashbookEntryResponse(
