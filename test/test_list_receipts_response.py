...
class TestListReceiptsResponse(unittest.TestCase):
    ...
    def testListReceiptsResponse(self):
        ...
        expected_json = "{'current_page': 10, 'data': [{'amount_gross': 3.14,           'amount_net': 3.14,           'amount_vat': 3.14,           'created_at': 'created_at_example',           'date': datetime.date(2022, 1, 1),           'description': 'description_example',           'id': 1,           'items_list': [{'amount_gross': 3.14,                           'amount_net': 3.14,                           'category': 'category_example',                           'id': 3,                           'vat': {'description': 'Non imponibile art. 123',                                   'e_invoice': True,                                   'ei_description': 'ei_description_example',                                   'ei_type': '2',                                   'id': 1,                                   'is_disabled': True,                                   'notes': 'IVA non imponibile ai sensi dell '                                            'articolo 123, comma 2',                                   'value': 22.0}}],           'number': 3.14,           'numeration': 'numeration_example',           'payment_account': {'cuc': 'cuc_example',                               'iban': 'iban_example',                               'id': 1,                               'name': 'Conto Banca Intesa',                               'sia': 'sia_example',                               'type': 'standard',                               'virtual': True},           'rc_center': 'rc_center_example',           'type': 'till_receipt',           'updated_at': 'updated_at_example',           'use_gross_prices': False},          {'amount_gross': 3.14,           'amount_net': 3.14,           'amount_vat': 3.14,           'created_at': 'created_at_example',           'date': datetime.date(2022, 1, 2),           'description': 'description_example',           'id': 2,           'items_list': [{'amount_gross': 3.14,                           'amount_net': 3.14,                           'category': 'category_example',                           'id': 3,                           'vat': {'description': 'Non imponibile art. 123',                                   'e_invoice': True,                                   'ei_description': 'ei_description_example',                                   'ei_type': '2',                                   'id': 1,                                   'is_disabled': True,                                   'notes': 'IVA non imponibile ai sensi dell '                                            'articolo 123, comma 2',                                   'value': 22.0}}],           'number': 3.14,           'numeration': 'numeration_example',           'payment_account': {'cuc': 'cuc_example',                               'iban': 'iban_example',                               'id': 1,                               'name': 'Conto Banca Intesa',                               'sia': 'sia_example',                               'type': 'standard',                               'virtual': True},           'rc_center': 'rc_center_example',           'type': 'till_receipt',           'updated_at': 'updated_at_example',           'use_gross_prices': False}], 'first_page_url': 'http://url.com', 'last_page': 10, 'last_page_url': 'http://url.com', 'next_page_url': 'http://url.com', 'path': 'http://url.com', 'per_page': 10, 'prev_page_url': 'http://url.com', 'to': 10, 'total': 10}"
