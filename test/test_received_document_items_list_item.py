...
class TestReceivedDocumentItemsListItem(unittest.TestCase):
    """ReceivedDocumentItemsListItem unit test stubs"""
    ...
    def testReceivedDocumentItemsListItem(self):
        """Test ReceivedDocumentItemsListItem"""
        model = ReceivedDocumentItemsListItem(
            id=1,
            product_id=1,
            code="code_example",
            name="name_example",
