...
class TestListF24ResponseAggregatedDataAggregatedData(unittest.TestCase):
    """ListF24ResponseAggregatedDataAggregatedData unit test stubs"""
    ...
    def testListF24ResponseAggregatedDataAggregatedData(self):
        ...
        model = ListF24ResponseAggregation(amount=10.0)
