...
class TestListCashbookEntriesResponse(unittest.TestCase):
    ...
    def testListCashbookEntriesResponse(self):
        ...
        expected_json = "{'current_page': 10, 'data': [{'amount_in': 10.0,           'date': datetime.date(2015, 5, 1),           'description': 'description',           'document': {'id': 1, 'path': '/path', 'type': 'doc'},           'entity_name': 'name',           'id': '1',           'kind': 'cashbook',           'payment_account_in': {'id': 1, 'name': 'banca'},           'type': 'in'}], 'first_page_url': 'http://url.com', 'last_page': 10, 'last_page_url': 'http://url.com', 'next_page_url': 'http://url.com', 'path': 'http://url.com', 'per_page': 10, 'prev_page_url': 'http://url.com', 'to': 10, 'total': 10}"
