...
class TestCompanyInfo(unittest.TestCase):
    ...
    def testCompanyInfo(self):
        ...
        expected_json = '{"id": 1, "name": "mario", "email": "mariomail@gm.co", "type": "company", "access_info": {"role": "master", "permissions": {}, "through_accountant": true}, "plan_info": {"limits": {"clients": 4000, "suppliers": 4000, "products": 4000, "documents": 4000}, "functions": {"archive": true, "cerved": true, "document_attachments": true}, "functions_status": {"ts_digital": {"active": true}, "ts_pay": {"active": true}}}, "accountant_id": 10, "is_accountant": true}'
