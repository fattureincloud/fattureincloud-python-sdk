...
class TestReceiptPreCreateInfo(unittest.TestCase):
    ...
    def testReceiptPreCreateInfo(self):
        ...
        expected_json = "{'categories_list': ['cat5', 'cat6'], 'numerations': {}, 'numerations_list': ['a/', 'b/'], 'payment_accounts_list': [{'id': 1, 'name': 'bank'}], 'rc_centers_list': ['bg', 'mi'], 'vat_types_list': [{'value': 22.0}]}"
