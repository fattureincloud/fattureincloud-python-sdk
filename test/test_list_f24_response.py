...
class TestListF24Response(unittest.TestCase):
    ...
    def testListF24Response(self):
        ...
        model = ListF24Response(
                ...
                F24(
                    id=2,
                    due_date=dateutil.parser.parse('2022.01.02').date(),
                    status=F24Status("paid"),
                    payment_account=PaymentAccount(
                        id=2,
        ...
        expected_json = "{'current_page': 10, 'data': [{'amount': 300.0,           'attachment_token': 'attachment_token_example',           'description': 'description_example',           'due_date': datetime.date(2022, 1, 1),           'id': 1,           'payment_account': {'cuc': 'cuc_example',                               'iban': 'iban_example',                               'id': 1,                               'name': 'Conto Banca Intesa',                               'sia': 'sia_example',                               'type': 'standard',                               'virtual': True},           'status': 'paid'},          {'amount': 31.0,           'attachment_token': 'attachment_token_example',           'description': 'description_example',           'due_date': datetime.date(2022, 1, 2),           'id': 2,           'payment_account': {'cuc': 'cuc_example',                               'iban': 'iban_example',                               'id': 2,                               'name': 'Conto Banca Unicredici',                               'sia': 'sia_example',                               'type': 'standard',                               'virtual': True},           'status': 'paid'}], 'first_page_url': 'http://url.com', 'last_page': 10, 'last_page_url': 'http://url.com', 'next_page_url': 'http://url.com', 'path': 'http://url.com', 'per_page': 10, 'prev_page_url': 'http://url.com', 'to': 10, 'total': 10}"
