...
class TestListReceivedDocumentsResponse(unittest.TestCase):
    ...
    def testListReceivedDocumentsResponse(self):
        ...
        expected_json = "{'data': [{'amortization': 3.14,           'amount_net': 3.14,           'amount_other_withholding_tax': 3.14,           'amount_vat': 3.14,           'amount_withholding_tax': 3.14,           'category': 'category_example',           'current_page': 10,           'date': datetime.date(2022, 1, 1),           'description': 'description_example',           'e_invoice': True,           'entity': {'id': 1, 'name': 'name_example'},           'first_page_url': 'http://url.com',           'id': 1,           'invoice_number': 'invoice_number_example',           'is_detailed': True,           'is_marked': True,           'items_list': [{'category': 'category_example',                           'code': 'code_example',                           'id': 1,                           'measure': 'measure_example',                           'name': 'name_example',                           'net_price': 3.14,                           'product_id': 1,                           'qty': 3.14,                           'stock': 3.14,                           'vat': {'description': 'Non imponibile art. 123',                                   'e_invoice': True,                                   'ei_description': 'ei_description_example',                                   'ei_type': '2',                                   'id': 1,                                   'is_disabled': True,                                   'notes': 'IVA non imponibile ai sensi dell '                                            'articolo 123, comma 2',                                   'value': 22.0}}],           'last_page': 10,           'last_page_url': 'http://url.com',           'next_page_url': 'http://url.com',           'path': 'http://url.com',           'per_page': 10,           'prev_page_url': 'http://url.com',           'rc_center': 'rc_center_example',           'tax_deductibility': 0.0,           'to': 10,           'total': 10,           'type': 'expense',           'vat_deductibility': 0.0}]}"
