...
class TestGetReceivedDocumentPreCreateInfoResponse(unittest.TestCase):
    ...
    def testGetReceivedDocumentPreCreateInfoResponse(self):
        ...
        expected_json = "{'data': {'categories_list': ['cat5', 'cat6'],          'countries_list': ['IT', 'US'],          'default_values': {'detailed': True},          'items_default_values': {'vat': 22.0},          'payment_accounts_list': [{'id': 1, 'name': 'bank'}],          'vat_types_list': [{'value': 22.0}]}}"
