...
class TestGetReceivedDocumentPreCreateInfoResponse(unittest.TestCase):
    ...
    def testGetReceivedDocumentPreCreateInfoResponse(self):
        ...
        expected_json = '{"data": {"default_values": {"detailed": true}, "items_default_values": {"vat": 22.0}, "countries_list": ["IT", "US"], "categories_list": ["cat5", "cat6"], "payment_accounts_list": [{"id": 1, "name": "bank", "type": "standard"}], "vat_types_list": [{"value": 22.0}]}}'
