...
class TestListSuppliersResponsePage(unittest.TestCase):
    """ListSuppliersResponsePage unit test stubs"""
    ...
    def testListSuppliersResponsePage(self):
        """Test ListSuppliersResponsePage"""
        model = ListSuppliersResponsePage(
            data=[
                Supplier(
                    id=1,
                    code="123",
