...
class TestModifyArchiveDocumentResponse(unittest.TestCase):
    ...
    def testModifyArchiveDocumentResponse(self):
        ...
        expected_json = "{'data': {'attachment_token': 'attachment_token_example',          'category': 'category_example',          'date': datetime.date(2022, 1, 1),          'description': 'description_example',          'id': 1}}"
