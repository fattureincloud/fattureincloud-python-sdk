...
class TestPermissionsFicIssuedDocumentsDetailed(unittest.TestCase):
    ...
    def testPermissionsFicIssuedDocumentsDetailed(self):
        ...
        expected_json = "{'creditNotes': 'write', 'deliveryNotes': 'write', 'invoices': 'write', 'orders': 'write', 'proformas': 'write', 'quotes': 'write', 'receipts': 'write', 'selfInvoices': 'write', 'supplierOrders': 'write', 'workReports': 'write'}"
