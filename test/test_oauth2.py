...
class TestOAuth2(unittest.TestCase):
    ...
    def testGetScopeStr(self):
        scopes = [Scope.SETTINGS_ALL, Scope.ISSUED_DOCUMENTS_INVOICE_READ]
    ...
    def testGetAuthorizationUrl(self):
        ...
        assert (
            url
            == "https://api-v2.fattureincloud.it/oauth/authorize?response_type=code&client_id=CLIENT_ID&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fredirect&scope=settings%3Aa+issued_documents.invoice%3Ar&state=EXAMPLE_STATE"
        )
