...
class TestModifyArchiveDocumentRequest(unittest.TestCase):
    """ModifyArchiveDocumentRequest unit test stubs"""
    ...
    def testModifyArchiveDocumentRequest(self):
        """Test ModifyArchiveDocumentRequest"""
        model = ModifyArchiveDocumentRequest(
