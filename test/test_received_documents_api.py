...
class TestReceivedDocumentsApi(unittest.TestCase):
    ...
    def test_get_received_document_pre_create_info(self):
        resp = {
            "status": 200,
            "data": b'{"data": {"default_values": {"detailed": true}, "items_default_values": {"vat": 22.0}, "countries_list": ["IT", "US"], "payment_accounts_list": [{"id": 1, "name": "bank", "type": "standard"}], "categories_list": ["cat5", "cat6"], "vat_types_list": [{"value": 22.0}]}}',
            "reason": "OK",
        }
