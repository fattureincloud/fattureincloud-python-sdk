...
class TestListCitiesResponse(unittest.TestCase):
    ...
    def testListCitiesResponse(self):
        ...
        expected_json = "{'current_page': 10, 'data': [{'city': 'bergamo', 'postal_code': '24121', 'province': 'BG'},          {'city': 'milano', 'postal_code': '25111', 'province': 'MI'}], 'first_page_url': 'http://url.com', 'last_page': 10, 'last_page_url': 'http://url.com', 'next_page_url': 'http://url.com', 'path': 'http://url.com', 'per_page': 10, 'prev_page_url': 'http://url.com', 'to': 10, 'total': 10}"
