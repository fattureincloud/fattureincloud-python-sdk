...
class TestCreateCashbookEntryRequest(unittest.TestCase):
    """CreateCashbookEntryRequest unit test stubs"""
    ...
    def testCreateCashbookEntryRequest(self):
        """Test CreateCashbookEntryRequest"""
        model = CreateCashbookEntryRequest(
