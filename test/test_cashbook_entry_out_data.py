...
class TestCashbookEntryOutData(unittest.TestCase):
    """CashbookEntryOutData unit test stubs"""
    ...
    def testCashbookEntryOutData(self):
        """Test CashbookEntryOutData"""
        model = CashbookEntryOutData(
            id="1",
        ...
        expected_json = "{'amount_out': 10.0, 'date': datetime.date(2015, 5, 1), 'description': 'description', 'document': {'id': 1, 'path': '/path', 'type': 'doc'}, 'entity_name': 'name', 'id': '1', 'kind': 'cashbook', 'payment_account_out': {'id': 1, 'name': 'banca'}, 'type': 'in'}"
