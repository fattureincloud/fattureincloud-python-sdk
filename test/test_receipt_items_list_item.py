...
class TestReceiptItemsListItem(unittest.TestCase):
    ...
    def testReceiptItemsListItem(self):
        ...
        expected_json = "{'amount_gross': 3.14, 'amount_net': 3.14, 'category': 'category_example', 'id': 3, 'vat': {'description': 'Non imponibile art. 123',         'e_invoice': True,         'ei_description': 'ei_description_example',         'ei_type': '2',         'id': 1,         'is_disabled': True,         'notes': 'IVA non imponibile ai sensi dell articolo 123, comma 2',         'value': 22.0}}"
