...
class TestListBinReceivedDocuments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListBinReceivedDocuments:
        """Test ListBinReceivedDocuments
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListBinReceivedDocuments`
        """
        model = ListBinReceivedDocuments()
        if include_optional:
            return ListBinReceivedDocuments(
                data = [
                    fattureincloud_python_sdk.models.received_document.ReceivedDocument(
                        id = 56, 
                        type = 'expense', 
