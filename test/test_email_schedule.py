...
class TestEmailSchedule(unittest.TestCase):
    ...
    def testEmailSchedule(self):
        ...
        expected_json = "{'attach_pdf': False, 'body': 'you won a chest of apples', 'include': {'accompanying_invoice': False,             'attachment': True,             'delivery_note': False,             'document': True}, 'recipient_email': 'recipient@mail.com', 'send_copy': True, 'sender_email': 'info@mail.com', 'sender_id': 1, 'subject': 'important'}"
