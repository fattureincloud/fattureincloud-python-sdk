...
class TestCashbookEntryData(unittest.TestCase):
    ...
    def testCashbookEntryData(self):
        ...
        expected_json = "{'amount_in': 10, 'date': datetime.date(2015, 5, 1), 'description': 'description', 'document': {'id': 1, 'path': '/path', 'type': 'doc'}, 'entity_name': 'name', 'id': '1', 'kind': 'cashbook', 'payment_account_in': {'id': 1, 'name': 'banca'}, 'type': 'in'}"
