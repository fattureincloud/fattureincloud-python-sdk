...
class TestListIssuedDocumentsResponsePage(unittest.TestCase):
    """ListIssuedDocumentsResponsePage unit test stubs"""
    ...
    def testListIssuedDocumentsResponsePage(self):
        """Test ListIssuedDocumentsResponsePage"""
        model = ListIssuedDocumentsResponsePage(
            data=[
                IssuedDocument(
                    id=1,
