...
class TestGetEmailDataResponse(unittest.TestCase):
    ...
    def testGetEmailDataResponse(self):
        ...
        expected_json = "{'data': {'accompanying_invoice_exists': False,          'attachment_exists': False,          'body': 'you won 13 billion indian rupies',          'cc_email': 'default@mail.com',          'default_attach_pdf': False,          'default_sender_email': {'email': 'ex.email@provider.co', 'id': 1},          'delivery_note_exists': False,          'document_exists': False,          'recipient_email': 'info@mail.com',          'sender_emails_list': [{'email': 'ex.email@provider.co', 'id': 1}],          'subject': 'important'}}"
